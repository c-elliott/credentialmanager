...
<div class="content-padded">
    ...
    {if $userid}
    <span class="sub-header">Credential Manager</span>
    <a class="btn btn-sm btn-success" role="button" target="_blank" rel="noopener noreferrer" href="addonmodules.php?module=credentialmanager&client_id={$userid}">Open Client</a>
    {/if}
